(function(){
  ...
  .controller('queueController', ['$scope', 'HttpService', '$routeParams', '$location', '$modal', 'WebSocketService', 'UserService', 'TitleService', 'ModalService', '$timeout',
    ...
    $scope.colorLocation = function (location) {
      ...
      pattern = /(blue|bl̴|red|r̦d|orange|yellow|gul|green|gr̦n|brown|brun|grey|gray|gr̴|karmosin|white|vit|magenta|violett|turkos|turquoise|game|play|spel|sport|music|musik|art|konst|food|mat)/g;
